                            ...
                            <ItemTemplate>
                                <table class="style1" style="padding: 5px; border-spacing: 5px">
                                    ...
                                    <tr>
                                        <td>Device Status:</td>
                                        <td>
                                            <asp:Label ID="LabelDeviceStatus" runat="server"
                                                       Text='<%# Bind("DeviceStatus") %>' ForeColor="Black" />
                                        </td>
                                        <td width="25"></td>
                                        <td>Alarm Message:</td>
                                        <td>
                                ...
                                &nbsp;<br />
                                &nbsp;<asp:LinkButton ID="UpdateButton" runat="server" CausesValidation="True" CommandName="Edit"
                                    ...
                                    <FooterTemplate>
                                        <div align="right">
                                            ...
                                            <asp:ConfirmButtonExtender ID="UpdateButton_ConfirmButtonExtender"
                                                runat="server" ConfirmText="Please confirm changes" Enabled="True" TargetControlID="UpdateButton" OnClientCancel="onCancel"></asp:ConfirmButtonExtender>
                                    ...
                                    <FooterTemplate>
                                        <div align="right">
                                            ...
                                            <asp:ConfirmButtonExtender ID="UpdateSubButton_ConfirmButtonExtender"
                                                runat="server" ConfirmText="Please confirm changes" Enabled="True" TargetControlID="UpdateSubButton" OnClientCancel="onCancel"></asp:ConfirmButtonExtender>
